...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        c7 = new JCheckBox("I hereby declares that the above entered details are correct to the bext of my knowledge");
        ...
        if(ae.getSource()== submit){
           ...
           try{
               if(accountType.equals("")){
                   JOptionPane.showMessageDialog(null, "Accunt Type is Required");
               }else{
                   Conn conn = new Conn();
